...
const statusStyle = {
  ...
  "Transferred to delivery partner": "bg-purple-100 text-purple-700",
};
...
const AllOrders = () => {
  ...
  return (
    <div className="w-full">
      <h1 className="mb-6 text-xl font-bold text-[#2E294E]">All Orders</h1>
      ...
      {orders && orders.length > 0 ? (
        ...
        <p className="py-10 text-center text-sm text-[#6b6480]">No orders yet.</p>
      )}
    </div>
  );
};
